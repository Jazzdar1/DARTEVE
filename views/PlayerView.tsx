...
// 🔥 THE FIX: Removed the #.html hack because it was breaking the streaming servers' internal routers, causing the black screen!
const STREAMING_SERVERS = [
    ...
    { id: 'multiembed', name: 'Server 4 (Backup)', getUrl: (id: string) => `https://multiembed.mov/?video_id=${id}&tmdb=1` }
];
                            ...
                            {searchResults.map((movie, idx) => (
                                ...
                                >
                                    <div className="relative aspect-[2/3] overflow-hidden bg-gray-900">
                                        <img 
                                            src={movie.Poster !== 'N/A' ? movie.Poster : `https://ui-avatars.com/api/?name=${encodeURIComponent(movie.Title)}&background=00b865&color=fff&size=512`} 
                                            alt={movie.Title} 
                                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" 
                                            onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(movie.Title)}&background=00b865&color=fff&size=512`; }}
                                        />
                                                ...
                                                >
                                                    <img 
                                                        ...
                                                        onError={(e) => {
                                                            ...
                                                            e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(movie.Title)}&background=00b865&color=fff&size=512`;
                                                        }}
                                                    />
